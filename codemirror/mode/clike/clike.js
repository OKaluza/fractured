...
CodeMirror.defineMode("clike", function(config, parserConfig) {
  var indentUnit = config.indentUnit,
      ...
      sections = parserConfig.sections || {},
  ...
  function tokenBase(stream, state) {
    ...
    if (contains(sections, cur) && stream.match(/:/)) return "section";
  ...
  def(["x-shader/x-vertex", "x-shader/x-fragment"], {
    ...
    atoms: words("true false " +
                ...
                "gl_MaxDrawBuffers " + //More fractal addons
                "z c z_1 z_2 point coord selected limit count escaped converged colour alpha " +
                "offset julia pixelsize dims origin selected_ palette background antialias"),
    //Fractal code sections
    sections: words("main functions init reset znext escaped converged transform calc result filter"),
    indentSwitch: false,
    hooks: {"#": cppHook,
      "@": function(stream, state) {
