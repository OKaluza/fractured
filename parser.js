...
break;
case 2:        
        if (yy[$$[$0-1]] == 'real' && yy.eval && yy.eval($$[$0-1]))
          this.$ = yy.eval($$[$0-1]);
        else
          this.$ = "(" + $$[$0-1] + ")" 
        yy[this.$] = yy[$$[$0-1]];
...
break;
case 11:
        if (yy.eval && yy.eval($$[$0-2]) == 0.0) this.$ = $$[$0];
        if (yy.eval && yy.eval($$[$0]) == 0.0) this.$ = $$[$0-2];
        else if (yy[$$[$0-2]] == 'real' && yy[$$[$0]] == 'real') {
          this.$ = $$[$0-2] + " + " + $$[$0];
          var ev = yy.eval ? yy.eval(this.$) : null;
          if (ev) this.$ = ev;
          yy[this.$] = 'real';
        } else if (yy[$$[$0-2]] == 'real') {
          this.$ = "C(" + $$[$0-2] + ",0) + " + $$[$0];
...
break;
case 13:
        if (yy.eval && yy.eval($$[$0-2]) == 1.0) this.$ = $$[$0];
        if (yy.eval && yy.eval($$[$0]) == 1.0) this.$ = $$[$0-2];
        if (yy[$$[$0-2]] == 'real' && yy[$$[$0]] == 'real') {
          this.$ = $$[$0-2] + " * " + $$[$0];
          var ev = yy.eval ? yy.eval(this.$) : null;
          if (ev) this.$ = ev;
...
break;
case 15:
        var power = yy.eval ? yy.eval($$[$0]) : $$[$0];
        if (power == 1.0) this.$ = $$[$0-2];
        else if (yy[$$[$0-2]] == 'real' && yy[$$[$0]] == 'real') {
          this.$ = "pow(" + $$[$0-2] + ", " + $$[$0] + ")";
          var ev = yy.eval ? yy.eval(this.$) : null;
          if (ev) this.$ = ev;
...
lexer.rules = [/^(?:\s+)/,/^(?:\(-?[0-9]+(\.[0-9]+)?\b,-?[0-9]+(\.[0-9]+)?\b\))/,/^(?:[0-9]+(\.[0-9]+)\b)/,/^(?:[0-9]+)/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:\^)/,/^(?:\()/,/^(?:\))/,/^(?:#)/,/^(?:\|\|)/,/^(?:\|)/,/^(?:,)/,/^(?:==)/,/^(?:!=)/,/^(?:<=)/,/^(?:=<)/,/^(?:>=)/,/^(?:=>)/,/^(?:<)/,/^(?:>)/,/^(?:!)/,/^(?:$)/,/^(?:E\b)/,/^(?:PI\b)/,/^(?:manhattan|norm|cabs|arg|imag|dot|real\b)/,/^(?:pow|exp|sin|cos|tan|asin|acos|atan|sinh|cosh|tanh|asinh|acosh|atanh|sqrt|ln|log10\b)/,/^(?:[@:]*[_a-zA-Z][_a-zA-Z0-9]*(\.[w-z])?)/,/^(?:.)/];
